...
The first Tabula slice is an in-memory, provider-neutral retrieval boundary.
It filters knowledge by organization, workspace, and Mission scope before
matching a query, then returns provenance-bearing records that can become Scout
evidence.
