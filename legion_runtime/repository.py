...
class AgentRepository(Protocol):
    ...
    def list_assignments_for_mission(
        self, mission_id: str
    ...
    def save_cognition_turn(self, *, work_item_id, attempt_id, correlation_id, facts) -> None: ...
    def list_cognition_turns(self, work_item_id: str) -> list[dict]: ...
